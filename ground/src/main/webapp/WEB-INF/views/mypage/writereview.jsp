    ...
    <div class="section1">
        <div class="contents">
         ...
         <table>
			    <tr>
			        <td>
			            <img src="/resources/images/poster/<%=request.getParameter("idx")%>.jpg"
			        ...
			        <td>
			            <table class="bigtable" style="padding: 20px;">
			                <tr>
			                    <td style="font-size : 20px; font-weight:bold;"><%=request.getParameter("idx")%></td>
			                    <td><input type="hidden" name="movieTitle" value="<%=request.getParameter("idx")%>" readonly></td>
			                    <td><input type="hidden" name="moviecode" value="<%=request.getParameter("id")%>" style = "padding : 20px;"></td>
			                </tr>
